...
public class BlobTest {
  ...
  public void test__execute__submitsCorrectRanges() {
    ...
    BlockManagerV2 blockManagerV2 = mock(BlockManagerV2.class);
    Blob blob = new Blob(TEST_URI, metadataStore, blockManagerV2);
    ...
    verify(blockManagerV2).makeRangeAvailable(0, 101);
    verify(blockManagerV2).makeRangeAvailable(999, 2);
  }
  ...
  public void test__close__closesBlockManager() {
    ...
    // Then:
    verify(blockManagerV2, times(1)).close();
  }
  ...
  private Blob getTestBlob(String data) {
    ...
    BlockManagerV2 blockManagerV2 = new BlockManagerV2(TEST_URI, fakeObjectClient, metadataStore);

    return new Blob(TEST_URI, metadataStore, blockManagerV2);
  }
}
